...
class UsageParsingTests(unittest.TestCase):
    ...
    def test_week_only_exhaustion_and_missing_reserve(self):
        ...
        self.assertEqual(overlay.usage_reset_fields(data)[0], "")
        self.assertEqual(overlay.usage_reset_fields(data)[1], dt.datetime.fromtimestamp(week["resets_at"]).strftime("%m/%d %H:%M"))
    ...
    def test_missing_reserve_does_not_reuse_previous_percentage(self):
        ...
        self.assertEqual(overlay.usage_fields(data)[0], "备用 --")
